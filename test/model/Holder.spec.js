...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Holder', function() {
      beforeEach(function() {
        instance = new BlockScoutApi.Holder();
      });

      it('should create an instance of Holder', function() {
        // TODO: update the code to test Holder
        expect(instance).to.be.a(BlockScoutApi.Holder);
      });
