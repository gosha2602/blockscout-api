...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RawTraceCallResult', function() {
      beforeEach(function() {
        instance = new BlockScoutApi.RawTraceCallResult();
      });

      it('should create an instance of RawTraceCallResult', function() {
        // TODO: update the code to test RawTraceCallResult
        expect(instance).to.be.a(BlockScoutApi.RawTraceCallResult);
      });
