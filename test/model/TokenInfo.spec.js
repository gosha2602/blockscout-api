...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenInfo', function() {
      beforeEach(function() {
        instance = new BlockScoutApi.TokenInfo();
      });

      it('should create an instance of TokenInfo', function() {
        // TODO: update the code to test TokenInfo
        expect(instance).to.be.a(BlockScoutApi.TokenInfo);
      });

      it('should have the property circulatingMarketCap (base name: "circulating_market_cap")', function() {
        // TODO: update the code to test the property circulatingMarketCap
        expect(instance).to.have.property('circulatingMarketCap');
        // expect(instance.circulatingMarketCap).to.be(expectedValueLiteral);
      });
