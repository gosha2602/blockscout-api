...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DecodedInputLogParameter', function() {
      beforeEach(function() {
        instance = new BlockScoutApi.DecodedInputLogParameter();
      });

      it('should create an instance of DecodedInputLogParameter', function() {
        // TODO: update the code to test DecodedInputLogParameter
        expect(instance).to.be.a(BlockScoutApi.DecodedInputLogParameter);
      });
