...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SearchResultTransaction', function() {
      beforeEach(function() {
        instance = new BlockScoutApi.SearchResultTransaction();
      });

      it('should create an instance of SearchResultTransaction', function() {
        // TODO: update the code to test SearchResultTransaction
        expect(instance).to.be.a(BlockScoutApi.SearchResultTransaction);
      });
