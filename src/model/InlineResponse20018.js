...
export class InlineResponse20018 {
   ...
   * @class
   * @param items {Array.<module:model/TokenInfo>} 
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [TokenInfo]);
...
/**
 * @member {Array.<module:model/TokenInfo>} items
 */
 ...
 */
InlineResponse20018.prototype.nextPageParams = undefined;
